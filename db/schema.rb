...
ActiveRecord::Schema[7.0].define(version: 2023_02_01_170419) do
  ...
  create_table "players", force: :cascade do |t|
    ...
    t.json "achievements_score", default: {"run_more_10000_meters"=>0, "scored_at_least_two_goals"=>0}, null: false
    t.bigint "team_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
